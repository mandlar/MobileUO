...
namespace ClassicUO.Game.Scenes
{
    internal partial class GameScene
    {
        ...
        private void GetViewPort()
        {
            ...
            int realMinRangeX = tileOffX - size;
            if (realMinRangeX < 0)
                realMinRangeX = 0;
            ...
            int realMinRangeY = tileOffY - size;
            if (realMinRangeY < 0)
                realMinRangeY = 0;
            ...
            //p.X = Camera.Bounds.X + Camera.Bounds.Width + drawOffset;
            //p.Y = Camera.Bounds.Y + Camera.Bounds.Height + drawOffset;
            //p = Camera.ScreenToWorld(p);
            //int maxPixelsX = p.X;
            //int maxPixelsY = p.Y;
